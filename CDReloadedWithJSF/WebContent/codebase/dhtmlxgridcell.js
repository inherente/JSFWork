...
function eXcell_ed(a){
    ...
    this.edit=function(){
        ...
        if(_isFF&&!window._KHTMLrv&&(this.obj.style.overflow="visible",this.grid.multiLine&&this.obj.offsetHeight>=18&&this.obj.offsetHeight<40))this.obj.style.height="36px",this.obj.style.overflow="scroll";
    ...
    this.getValue=function(){
        return this.cell.firstChild&&
        this.cell.atag&&this.cell.firstChild.tagName==this.cell.atag?this.cell.firstChild.value:this.cell._clearCell?"":this.cell.innerHTML.toString()._dhx_trim()
    };
...
function eXcell_co(a){
    ...
    this.edit=function(){
        ...
        this.list.onclick=function(a){
            var b=a||window.event,d=b.target||b.srcElement;
            if(d.tagName==
                "OPTION")d=d.parentNode;
            c.editable=!1;
            c.grid.editStop();
            b.cancelBubble=!0
        };
        ...
        this.list.size="6";
        this.cstate=1;
        this.editable?this.cell.innerHTML=
        "":(this.obj.style.width="1px",this.obj.style.height="1px");
        this.cell.appendChild(this.obj);
    ...
    this.detach=function(){
        ...
        if(this.list.parentNode!=null)if(this.editable){
            ...
            if(a&&a.text==this.obj.value)this.setValue(this.list.value);
                ...
                d!=-1?this.setValue(c.keys[d]):this.setCValue(this.cell.combo_value=this.obj.value)
            }
...
function eXcell_price(a){
    ...
    this.base(a);
    this.getValue=function(){
        return this.cell.childNodes.length>1?this.cell.childNodes[1].innerHTML.toString()._dhx_trim():""
    }
}
...
eXcell_price.prototype.setValue=function(a){
    ...
    var b="black";
    a<0&&(b="red");
    this.setCValue("<span style='padding-right:2px;color:"+b+";'>"+a+"</span>",a)
};
...
eXcell_dyn.prototype.setValue=function(a){
    ...
    if(a>0)var b="black",c="dyn_up.gif";else a==0?(b="black",c="dyn_.gif"):(b="black",c="dyn_down.gif");
    this.setCValue("<div style='position:relative;padding-right:2px; width:100%;overflow:hidden; white-space:nowrap;'><img  height='0' style='position:absolute;top:0px;left:0px;'><span style=' padding-left:20px; width:100%;color:"+b+";'>"+a+"</span></div>",a)
};
...
function dhtmlXGridComboObject(){
    ...
    this.put=function(a,b){
        for(var c=0;c<this.keys.length;c++)if(this.keys[c]==a)return this.values[c]=b,!0;this.values[this.values.length]=b;
        this.keys[this.keys.length]=a
    };
        
    this.get=function(a){
        for(var b=0;b<this.keys.length;b++)if(this.keys[b]==a)return this.values[b];return null
    };
